package poo.herencia.ejemplo;

import poo.herencia.pooHerencia.*;

public class EjemploHerenciaConstructores {
    public static void main(String[] args) {

        System.out.println("======== Creando la instancia de la clase Alumno ========");
        Alumno alumno = new Alumno("Eduardo", "Escobar", 13, "Instituto Nacional");
        ...
        AlumnoInternacional alumnoInt = new AlumnoInternacional("Angela", "Contreras", "Australia");
